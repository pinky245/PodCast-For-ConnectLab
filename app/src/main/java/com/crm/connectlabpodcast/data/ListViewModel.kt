...
class ListViewModel @ViewModelInject constructor(
    ...
    // live data list
    lateinit var list: LiveData<List<Record>>
    lateinit var rcRepository: RecordRepository
    ...
    fun initPlayer(recordRepository: RecordRepository) {
        rcRepository = recordRepository
         list = recordRepository.fetchRecords().asLiveData()
